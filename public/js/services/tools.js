    ...
    .service('Tools', function ($mdDialog, $mdToast, $http, serverRef,$rootScope) {
        ...
        scope.loader = function () {
            return $mdDialog.show({
                template: "" +
                "<div layout-padding layout='row' layout-align='center center' class='md-whiteframe-20dp'>" +
        ...
        scope.themes = [
            ...
            'http://www.hdwallpapery.com/static/images/Abstract_Blue_backgrounds_40_XuccugE.jpg',
            'http://www.hdwallpapery.com/static/images/abstract-wallpapers-flower-vector-backgrounds-wallpaper-33960_pfJKeAd.jpg',
            'http://interfacelift.com/wallpaper/previews/01407_harboursunset_672x420.jpg',
            'http://www.hdwallpapery.com/static/images/abstract-colorful-background_zogWBZG.jpg',
            'http://www.hdwallpapery.com/static/images/Abstract-Blue-Backgrounds_hMCvKRI.jpg',
            'http://www.hdwallpapery.com/static/images/1771862_cwqSW3w.jpg',
